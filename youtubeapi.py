...
#
# Modified for Python 3.x by Christophe-A. Gassmann
# ---------------------------------------------------------------------------
...
class YoutubeAPI:
    ...
    #added for long playlists (paged) (more than 50 videos) [Christophe-A]
    def get_playlist_items_by_playlist_id_paginated(self, playlist_id, max_results=50, token=None):
